...
**Docker Run**  
```
docker run -it --name lollipop-build-env --restart always --volume /home/roy:/home/roy --volume /etc/passwd:/etc/passwd --volume /data/work/src:/work/src --volume /etc/localtime:/etc/localtime:ro lollipop-build-env:0.1
```
...
```
docker exec -u 1000 -it lollipop-build-env bash /work/src/pf-pro-r/run_build.sh
````
